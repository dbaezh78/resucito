...
const initializeCantoPage = (cantoSpecificData, processedCategories) => {
    ...
    if (!showAllAsambleaIcon) console.error("Error: .mso1 no encontrado dentro de #showAllAsambleaBtn.");
    if (!toggleVistaBtn) console.error("Error: #toggleVista no encontrado.");
    if (!toggleVistaIcon) console.error("Error: .mso1 no encontrado dentro de #toggleVista.");
