...
const allCantosData = [
    ...
    //  A NADIE DEMOS OCASIÓN DE TROPIEZO
    {
        ...
        lizq: [
            { line: "Hermanos, a nadie demos ocasión de tropiezo, (La,m,16)(Re,m,409)", sC: "tc" },
            { line: "hermanos, vivamos aceptando las tribulaciones, (Mi,,61) (La,m,409)" },
            { line: "necesidades, angustias y fatigas,   (Re,m,16) (Mi,,275)" },
            { line: "viviendo en pureza, paciencia y bondad, (Re,m,16) (Mi,,354)" },
            { line: "en el Espíritu Santo, y en el poder de Dios, (Fa,,143)(Mi,,378)" },
            { line: "con las armas de la justicia, (Fa,,224)" },
            { line: "las de la derecha y las de la izquierda. (Mi,,318)" },
            
            { line: "HERMANOS, A NADIE DEMOS (La,m,18)", sC: "mt ta as" },
            { line: "OCASIÓN DE TROPIEZO,    (Re,m,183)", sC: "as" },
            { line: "HERMANOS, VIVAMOS ACEPTANDO (Mi,,60)", sC: "as" },
            { line: "LAS TRIBULACIONES,  (La,m,145)", sC: "as" },
            { line: "NECESIDADES, ANGUSTIAS Y FATIGAS. (Re,m,18)(Mi,,319)", sC: "as" },

            { line: "En calumnias y en buena fama, (Re,m,15) (Mi,,56)", sC: "mt tc" },
            { line: "en gloria e ignominia(Mi,,65)nia, (Re,m,15) (Mi,,56)" },
            { line: "como pobres, aunque enriqueciendo a muchos; (Fa,,15)" },
            { line: "como quienes nada tienen, (Mi,,56)" },
        ...
        lder: [
            { line: "Hermanos, os hemos hablado con franqueza, (Mi,,46)", sC: "tc" },
            { line: "os hemos hablado en toda verdad. (Re,m,15) (Mi,,46)", sC: "" },
            { line: "No unciros al yugo desigual con los paganos. (Re,m,15) (Mi,,196)" },
            { line: "¿Qué participación hay entre el fiel y el infiel? (Fa,,196)" },
            { line: "¿Qué unión entre el santuario de Dios (Mi,,56) " },
            { line: "y el santuario de los ídolos? (Re,m,15) (Mi,,56)" },
            ...
            { line: "Tengo plena confianza en el hablaros, (Mi,,56)", sC: "mt tc" },
            { line: "porque estoy orgulloso de vosotros. (Re,m,15) (Mi,,56)" },
            { line: "No unciros al yugo desigual con los paganos. (Re,m,15) (Mi,,56)" },
            ...
            { line: "En pureza, paciencia y bondad, (Re,m,15) (Mi,,56)", sC: "mt tc" },
            { line: "en el Espíritu Santo, y en el poder de Dios. (Fa,,15)(Mi,,56)" },
        ]
