...
// NUEVO CÓDIGO PARA AÑADIR URL
    if (lineaParsed.url) {
        const linkElement = document.createElement('a');
        linkElement.href = lineaParsed.url;
        linkElement.classList.add('canto-link'); // Opcional: añade una clase para estilizar el enlace
        linkElement.appendChild(letraSpan);
        lineaDiv.appendChild(linkElement);
    } else {
