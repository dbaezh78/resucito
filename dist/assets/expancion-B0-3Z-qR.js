...
import{A as e,T as t,_ as n,b as r,c as i,f as a,i as o,k as s,l as c,m as l,p as u,t as d,u as f,v as p,x as m}from"./preload-helper-qbBc4K6s.js";var h=[],g={songs:{}};function _(e,t=!1){let n=document.getElementById(`expansion-toast`);n&&n.remove();let r=document.createElement(`div`);r.id=`expansion-toast`,r.style.cssText=`
        position: fixed;
        bottom: 24px;
        right: 24px;
